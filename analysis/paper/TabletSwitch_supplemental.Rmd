...
TableS1 <- structure(
  list(
    " " = c("Overall", 
            ...
            " English", 
            " French/Spanish",
            "More proficient in French/Spanish", 
            " English", 
            " French/Spanish"),
    "N (%)" = c(paste0(mean_proficiency$n[mean_proficiency$lang_comm=="French-English"], " (", round(mean_proficiency$n[mean_proficiency$lang_comm=="French-English"]/31*100),"%)"), 
                " ", 
                " ",
                paste0(equal_proficiency$n[equal_proficiency$lang_comm=="French-English"], " (", round(equal_proficiency$n[equal_proficiency$lang_comm=="French-English"]/31*100), "%)"),
                paste0(dominant_eng_proficiency$n[dominant_eng_proficiency$lang_comm=="French-English"], 
                       " (", round(dominant_eng_proficiency$n[dominant_eng_proficiency$lang_comm=="French-English"]/31*100), "%)"), 
                " ", 
                " ",
                paste0(dominant_fr_proficiency$n, " (", round(dominant_fr_proficiency$n/31*100), "%)"), 
                " ", 
                " "),
    "Mean (SD)" = c(" ", 
                    paste0(mean_proficiency$mean_proficiency_eng[mean_proficiency$lang_comm=="French-English"], 
                           " (", mean_proficiency$sd_proficiency_eng[mean_proficiency$lang_comm=="French-English"],")"), 
                    paste0(mean_proficiency$mean_proficiency_fr[mean_proficiency$lang_comm=="French-English"], 
                           " (", mean_proficiency$sd_proficiency_fr[mean_proficiency$lang_comm=="French-English"],")"),
                    paste0(equal_proficiency$mean_proficiency_eng[equal_proficiency$lang_comm=="French-English"], 
                           " (", equal_proficiency$sd_proficiency_eng[equal_proficiency$lang_comm=="French-English"],")"),
                    " ", 
                    paste0(dominant_eng_proficiency$mean_proficiency_eng[dominant_eng_proficiency$lang_comm=="French-English"], 
                           " (", dominant_eng_proficiency$sd_proficiency_eng[dominant_eng_proficiency$lang_comm=="French-English"],")"), 
                    paste0(dominant_eng_proficiency$mean_proficiency_fr[dominant_eng_proficiency$lang_comm=="French-English"], 
                           " (", dominant_eng_proficiency$sd_proficiency_fr[dominant_eng_proficiency$lang_comm=="French-English"],")"),
                    " ", 
                    paste0(dominant_fr_proficiency$mean_proficiency_eng, " (", dominant_fr_proficiency$sd_proficiency_eng,")"), 
                    paste0(dominant_fr_proficiency$mean_proficiency_fr, " (", dominant_fr_proficiency$sd_proficiency_fr,")")),
    "Range" = c("",
                paste(mean_proficiency$min_proficiency_eng[mean_proficiency$lang_comm=="French-English"],
                      mean_proficiency$max_proficiency_eng[mean_proficiency$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                paste(mean_proficiency$min_proficiency_fr[mean_proficiency$lang_comm=="French-English"],
                      mean_proficiency$max_proficiency_fr[mean_proficiency$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                paste(equal_proficiency$min_proficiency_eng[equal_proficiency$lang_comm=="French-English"],
                      equal_proficiency$max_proficiency_eng[equal_proficiency$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_eng_proficiency$min_proficiency_eng[dominant_eng_proficiency$lang_comm=="French-English"],
                      dominant_eng_proficiency$max_proficiency_eng[dominant_eng_proficiency$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                paste(dominant_eng_proficiency$min_proficiency_fr[dominant_eng_proficiency$lang_comm=="French-English"],
                      dominant_eng_proficiency$max_proficiency_fr[dominant_eng_proficiency$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_fr_proficiency$min_proficiency_eng,
                      dominant_fr_proficiency$max_proficiency_eng, 
                      sep=" \u2013 "),
                paste(dominant_fr_proficiency$min_proficiency_fr,
                      dominant_fr_proficiency$max_proficiency_fr, 
                      sep=" \u2013 ")),
    "N (%)" = c(paste0(mean_proficiency$n[mean_proficiency$lang_comm=="Spanish-English"], " (", round(mean_proficiency$n[mean_proficiency$lang_comm=="Spanish-English"]/22*100),"%)"), 
                " ", 
                " ",
                paste0(equal_proficiency$n[equal_proficiency$lang_comm=="Spanish-English"], " (", round(equal_proficiency$n[equal_proficiency$lang_comm=="Spanish-English"]/22*100), "%)"),
                paste0(dominant_eng_proficiency$n[dominant_eng_proficiency$lang_comm=="Spanish-English"], 
                       " (", round(dominant_eng_proficiency$n[dominant_eng_proficiency$lang_comm=="Spanish-English"]/22*100), "%)"), 
                " ", 
                " ",
                paste0(dominant_sp_proficiency$n, " (", round(dominant_sp_proficiency$n/22*100), "%)"), 
                " ", 
                " "),
    "Mean (SD)" = c(" ", 
                    paste0(mean_proficiency$mean_proficiency_eng[mean_proficiency$lang_comm=="Spanish-English"], 
                           " (", mean_proficiency$sd_proficiency_eng[mean_proficiency$lang_comm=="Spanish-English"],")"), 
                    paste0(mean_proficiency$mean_proficiency_sp[mean_proficiency$lang_comm=="Spanish-English"], 
                           " (", mean_proficiency$sd_proficiency_sp[mean_proficiency$lang_comm=="Spanish-English"],")"),
                    paste0(equal_proficiency$mean_proficiency_eng[equal_proficiency$lang_comm=="Spanish-English"], 
                           " (", equal_proficiency$sd_proficiency_eng[equal_proficiency$lang_comm=="Spanish-English"],")"),
                    " ", 
                    paste0(dominant_eng_proficiency$mean_proficiency_eng[dominant_eng_proficiency$lang_comm=="Spanish-English"], 
                           " (", dominant_eng_proficiency$sd_proficiency_eng[dominant_eng_proficiency$lang_comm=="Spanish-English"],")"), 
                    paste0(dominant_eng_proficiency$mean_proficiency_sp[dominant_eng_proficiency$lang_comm=="Spanish-English"], 
                           " (", dominant_eng_proficiency$sd_proficiency_sp[dominant_eng_proficiency$lang_comm=="Spanish-English"],")"),
                    " ", 
                    paste0(dominant_sp_proficiency$mean_proficiency_eng, " (", dominant_sp_proficiency$sd_proficiency_eng,")"), 
                    paste0(dominant_sp_proficiency$mean_proficiency_sp, " (", dominant_sp_proficiency$sd_proficiency_sp,")")),
    "Range" = c("",
                paste(mean_proficiency$min_proficiency_eng[mean_proficiency$lang_comm=="Spanish-English"],
                      mean_proficiency$max_proficiency_eng[mean_proficiency$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                paste(mean_proficiency$min_proficiency_sp[mean_proficiency$lang_comm=="Spanish-English"],
                      mean_proficiency$max_proficiency_sp[mean_proficiency$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                paste(equal_proficiency$min_proficiency_eng[equal_proficiency$lang_comm=="Spanish-English"],
                      equal_proficiency$max_proficiency_eng[equal_proficiency$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_eng_proficiency$min_proficiency_eng[dominant_eng_proficiency$lang_comm=="Spanish-English"],
                      dominant_eng_proficiency$max_proficiency_eng[dominant_eng_proficiency$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                paste(dominant_eng_proficiency$min_proficiency_sp[dominant_eng_proficiency$lang_comm=="Spanish-English"],
                      dominant_eng_proficiency$max_proficiency_sp[dominant_eng_proficiency$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_sp_proficiency$min_proficiency_eng,
                      dominant_sp_proficiency$max_proficiency_eng, 
                      sep=" \u2013 "),
                paste(dominant_sp_proficiency$min_proficiency_sp,
                      dominant_sp_proficiency$max_proficiency_sp, 
                      sep=" \u2013 "))
...
TableS1_indent <- list(c(2,3,6,7,9,10))

papaja::apa_table(TableS1,
                  caption = "Table S1. Language proficiency scores across the two groups of bilingual children. Proficiency data were missing for 1 French–English and 3 Spanish–English bilingual children.",
                  align = c("l", rep("c", 6)),
                  stub_indents = TableS1_indent,
                  col_spanners = list("French\u2013English" = 2:4, "Spanish\u2013English" = 5:7),
                  landscape = FALSE,
                  placement = "H")
...
## Detailed descriptive statistics of the children’s exposure to each language
```{r include=FALSE, cache=TRUE}
# ---------- global exposure descriptive stats ----------
## Overall mean proficiency scores
mean_exposure <- data_clean %>%
  # filter out missing_LEQ
  filter(missing_LEQ != 1) %>%
  distinct(subject_id, .keep_all = T) %>%
  select(subject_id, lang_comm, matches("global_")) %>%
  group_by(lang_comm) %>%
  dplyr::summarize(n = length(subject_id),
            # English
            mean_exposure_eng = mean(global_exposure_eng, na.rm = T),
            sd_exposure_eng = sd(global_exposure_eng, na.rm = T),
            min_exposure_eng = min(global_exposure_eng, na.rm = T),
            max_exposure_eng = max(global_exposure_eng, na.rm = T),
            # French
            mean_exposure_fr = mean(global_exposure_fr, na.rm = T),
            sd_exposure_fr = sd(global_exposure_fr, na.rm = T),
            min_exposure_fr = min(global_exposure_fr, na.rm = T),
            max_exposure_fr = max(global_exposure_fr, na.rm = T),
            # Spanish
            mean_exposure_sp = mean(global_exposure_sp, na.rm = T),
            sd_exposure_sp = sd(global_exposure_sp, na.rm = T),
            min_exposure_sp = min(global_exposure_sp, na.rm = T),
            max_exposure_sp = max(global_exposure_sp, na.rm = T)) %>%
  mutate(across(is.numeric, ~ round(., 2)))
...
```{r include=FALSE, cache=TRUE}
## lm model to compare exposure
exposure_model <- data_clean %>%
  select(subject_id, lang_comm, matches("global_"), -global_exposure_other) %>%
  distinct(subject_id, .keep_all = TRUE) %>%
  mutate_at(vars(-c(subject_id, lang_comm)), ~as.numeric(.)) %>%
  mutate(global_exposure_other = case_when(!is.na(global_exposure_fr) ~ global_exposure_fr,
                                                     !is.na(global_exposure_sp) ~ global_exposure_sp,
                                                     TRUE ~ NA_real_)) %>%
  select(-c(global_exposure_fr, global_exposure_sp)) %>%
  pivot_longer(-c(subject_id, lang_comm), names_to = "language", values_to = "exposure") %>%
  mutate(language = recode(language,
                           global_exposure_eng = "English",
                           global_exposure_other = "French/Spanish")) %>%
  lm(exposure ~ language * lang_comm, data = .,
     contrasts = list(language = contr.sum(2)/2,
                      lang_comm = contr.sum(2)/2))
...
As mentioned in the main paper, in addition to children’s language proficiency, we also asked caregivers to report their child’s percentage global exposure to the two languages[^2]. Overall, French–English children had an average global exposure of `r round(mean_exposure[1,3])`% to English ($SD$ = `r round(mean_exposure[1,4], 2)`, range = `r round(mean_exposure[1,5])` – `r round(mean_exposure[1,6])`) and `r round(mean_exposure[1,7])`% to French ($SD$ = `r round(mean_exposure[1,8], 2)`, range = `r round(mean_exposure[1,9])` – `r round(mean_exposure[1,10])`); whereas Spanish–English children had an average global exposure of `r round(mean_exposure[2,3])`% to English ($SD$ = `r round(mean_exposure[2,4], 2)`, range = `r round(mean_exposure[2,5])` – `r round(mean_exposure[2,6])`) and `r round(mean_exposure[2,11])`% to Spanish ($SD$ = `r round(mean_exposure[2,12], 2)`, range = `r round(mean_exposure[2,13])` – `r round(mean_exposure[2,14])`). A linear regression model with global exposure as the dependent variable was run, with fixed effects of language community (French–English vs. Spanish–English) and language (English vs. French/Spanish), as well as their interaction:

exposure ~ language * lang_community

\noindent We found no significant effect of language, language community, nor their interaction ($p$s > `r round(min((broom::tidy(exposure_model) %>% filter(term != "(Intercept)"))$p.value),3)`. Therefore, the two groups of bilinguals did not significantly differ in terms of their global exposure to English versus to the other language (i.e., French for the French–English children and Spanish for the Spanish–English children).

[^2]: The question asked was “if you think about your child’s entire life, what percentage of the words that your child has heard are in English/French/Spanish/another language”.

## Detailed descriptive statistics of the caregivers’ code-switching ratings
```{r include=FALSE, cache=TRUE}
# ---------- global exposure descriptive stats ----------
## Overall mean proficiency scores
mean_codeswitch <- data_clean %>%
  # filter out missing_LEQ
  filter(missing_LEQ != 1) %>%
  distinct(subject_id, .keep_all = T) %>%
  select(subject_id, lang_comm, matches("codeswitch_"), -codeswitch_average) %>%
  group_by(lang_comm) %>%
  dplyr::summarize(n = length(subject_id),
            # within-sentence codeswitch
            mean_codeswitch_within = mean(codeswitch_within_sentence, na.rm = T),
            sd_codeswitch_within = sd(codeswitch_within_sentence, na.rm = T),
            min_codeswitch_within = min(codeswitch_within_sentence, na.rm = T),
            max_codeswitch_within = max(codeswitch_within_sentence, na.rm = T),
            # French
            mean_codeswitch_between = mean(codeswitch_between_sentence, na.rm = T),
            sd_codeswitch_between = sd(codeswitch_between_sentence, na.rm = T),
            min_codeswitch_between = min(codeswitch_between_sentence, na.rm = T),
            max_codeswitch_between = max(codeswitch_between_sentence, na.rm = T)) %>%
  mutate(across(is.numeric, ~ round(., 2)))
...
TableS2 <- structure(
  list(
    " " = c("Within-sentence codeswitching", "Between-sentence codeswitching"),
    "Mean (SD)" = c(paste0(mean_codeswitch$mean_codeswitch_within[mean_codeswitch$lang_comm=="French-English"], " (", 
                          mean_codeswitch$sd_codeswitch_within[mean_codeswitch$lang_comm=="French-English"], ")"), 
                    paste0(mean_codeswitch$mean_codeswitch_between[mean_codeswitch$lang_comm=="French-English"], " (", 
                          mean_codeswitch$sd_codeswitch_between[mean_codeswitch$lang_comm=="French-English"], ")")),
    "range" = c(paste(mean_codeswitch$min_codeswitch_within[mean_codeswitch$lang_comm=="French-English"],  
                      mean_codeswitch$max_codeswitch_within[mean_codeswitch$lang_comm=="French-English"], sep=" \u2013 "),
                paste(mean_codeswitch$min_codeswitch_between[mean_codeswitch$lang_comm=="French-English"],  
                      mean_codeswitch$max_codeswitch_between[mean_codeswitch$lang_comm=="French-English"], sep=" \u2013 ")),
    "Mean (SD)" = c(paste0(mean_codeswitch$mean_codeswitch_within[mean_codeswitch$lang_comm=="Spanish-English"], " (", 
                          mean_codeswitch$sd_codeswitch_within[mean_codeswitch$lang_comm=="Spanish-English"], ")"), 
                    paste0(mean_codeswitch$mean_codeswitch_between[mean_codeswitch$lang_comm=="Spanish-English"], " (", 
                          mean_codeswitch$sd_codeswitch_between[mean_codeswitch$lang_comm=="Spanish-English"], ")")),
    "range" = c(paste(mean_codeswitch$min_codeswitch_within[mean_codeswitch$lang_comm=="Spanish-English"],  
                      mean_codeswitch$max_codeswitch_within[mean_codeswitch$lang_comm=="Spanish-English"], sep=" \u2013 "),
                paste(mean_codeswitch$min_codeswitch_between[mean_codeswitch$lang_comm=="Spanish-English"],  
                      mean_codeswitch$max_codeswitch_between[mean_codeswitch$lang_comm=="Spanish-English"], sep=" \u2013 "))
  ),
  class = "data.frame",
  row.names = c(NA, 2L)
)

papaja::apa_table(TableS2,
                  caption = "Table S2. Caregivers’ self-reported codeswitching rating across the two groups of bilingual children.",
                  align = c("m{6cm}", "m{2.5cm}", "c", "m{2.5cm}", "c"),
                  col_spanners = list("French\u2013English" = c(2,3), "Spanish\u2013English" = c(4,5)),
                  landscape = FALSE,
                  placement = "H")
```
...
```{r include=FALSE, cache=TRUE}
## lm model to compare exposure
codeswitch_model <- data_clean %>%
  select(subject_id, lang_comm, matches("codeswitch_"), -codeswitch_average) %>%
  distinct(subject_id, .keep_all = TRUE) %>%
  mutate_at(vars(-c(subject_id, lang_comm)), ~as.numeric(.)) %>%
  pivot_longer(-c(subject_id, lang_comm), names_to = "pattern", values_to = "rating") %>%
  lm(rating ~ pattern * lang_comm, data = .,
     contrasts = list(language = contr.sum(2)/2,
                      lang_comm = contr.sum(2)/2))
  
summary(codeswitch_model)
```
...
rating ~ pattern * lang_community

\noindent There was a significant effect of pattern, suggesting that overall caregivers switched languages between sentences more often than within sentences (Estimate = `r round((broom.mixed::tidy(codeswitch_model) %>% filter(term == "patterncodeswitch_within_sentence"))$estimate,2)`, $SE$ = `r round((broom.mixed::tidy(codeswitch_model) %>% filter(term == "patterncodeswitch_within_sentence"))$std.error,2)`, $t$ = `r round((broom.mixed::tidy(codeswitch_model) %>% filter(term == "patterncodeswitch_within_sentence"))$statistic,2)`, $p$ `r (broom.mixed::tidy(codeswitch_model) %>% mutate(p.value = case_when(p.value < .01 ~ "< .01")) %>% filter(term == "patterncodeswitch_within_sentence"))$p.value`). However, we found no significant effect of language nor language community ($p$s > `r round(min((broom::tidy(codeswitch_model) %>% filter(term != "(Intercept)" & term != "patterncodeswitch_within_sentence"))$p.value),3)`). 
...
papaja::apa_table(test_acc_model_age_coefs, 
                  ...
                  align=c("l","c","c","c","c"),
                  caption="Table S3. Coefficient estimates from the logistic mixed-effects models predicting accuracy in the test blocks with age_in_months as an additional fixed effect.",
                  landscape = FALSE,
                  placement = "H")
```
...
papaja::apa_table(test_rt_model_with_age_coefs, 
                  ...
                  align=c("l","c","c","c","c"),
                  caption="Table S4. Coefficient estimates from the linear mixed-effects model predicting log-transformed response time in the test blocks.",
                  landscape = FALSE,
                  placement = "H")
```
...
papaja::apa_table(test_acc_model_with_proficiency_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("m{6cm}", rep("c", 4)),
                  caption="Table S5. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test blocks with language proficiency scores.",
                  landscape = FALSE,
                  placement = "H")
```
...
In addition to language proficiency, we also explored the effect of global language exposure on bilingual children’s learning of the novel cross-language words. Similar to the analysis on language proficiency, we first added a variable of global exposure to the logistic mixed-effects model used in the main accuracy analysis. Global exposure,a continuous variable with caregiver-reported global language exposure in each language, was used to predict children’s performance on trials in that same language. Data from `r mean_exposure$n[mean_exposure$lang_comm=="French-English"]` French–English and `r mean_exposure$n[mean_exposure$lang_comm=="Spanish-English"]` Spanish–English children remained in the analysis (i.e., after excluding one French–English and three Spanish–English children participants who were missing their language exposure information). The final model specification after pruning random intercept of item and the random slope for condition for model convergence was:
	
accuracy ~ condition * lang_community * exposure + (1|participant) 

```{r include=FALSE, cache=TRUE}
### glmer model
test_acc_model_with_exposure_withlangcomm <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  # remove subject_id whose proficiency info are missing (n=4)
  filter(missing_LEQ != 1) %>%
  # create a exposure variable for the tested language
  mutate(exposure = case_when(
    language == "english" ~ as.numeric(global_exposure_eng),
    language == "french" ~ as.numeric(global_exposure_fr),
    language == "spanish" ~ as.numeric(global_exposure_sp),
    TRUE ~ NA_real_)) %>%
  mutate(condition = as.factor(condition),
         lang_comm = as.factor(lang_comm)) %>%
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1+ condition|subject_id) + (1|stimulus), family = binomial, data = .)
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id) + (1|stimulus), family = binomial, data = .)
  glmer(accuracy ~ condition * lang_comm * exposure + (1|subject_id), family = binomial, data = .,
        contrasts = list(condition = contr.sum(2)/-2,
                         lang_comm = contr.sum(2)/-2))


test_acc_model_with_exposure <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id) + (1|stimulus), family = binomial, data = .)
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id), family = binomial, data = .)
  glmer(accuracy ~ condition * exposure + (1|subject_id), family = binomial, data = .,
        contrasts = list(condition = contr.sum(2)/-2))

anova(test_acc_model_with_exposure_withlangcomm, test_acc_model_with_exposure)

broom.mixed::tidy(test_acc_model_with_exposure_withlangcomm) %>%
  mutate_if(is.numeric, round, digits = 3) 

### goodness of fit
#testUniformity(test_acc_model_with_exposure_withlangcomm)
#testDispersion(test_acc_model_with_exposure_withlangcomm) 
#plotQQunif(test_acc_model_with_exposure_withlangcomm)
```
...
```{r results = "asis", cache = TRUE, warning=FALSE, message=FALSE}
### Table S6
test_acc_model_with_exposure_withlangcomm_coefs <- summary(test_acc_model_with_exposure_withlangcomm)$coef %>%
  as.data.frame %>%
  mutate_at(c("Estimate","Std. Error", "z value", "Pr(>|z|)"), 
            function (x) signif(x, digits = 3)) %>% 
  rename(SE = `Std. Error`, 
...
rownames(test_acc_model_with_exposure_withlangcomm_coefs) <- c("Intercept", "condition", "lang_community" ,"exposure", 
                                                         "condition * lang_community", "condition * exposure", 
                                                         "lang_community * exposure", "condition * lang_community * exposure")

papaja::apa_table(test_acc_model_with_exposure_withlangcomm_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S6. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test blocks with global language exposure.",
                  landscape = FALSE, 
                  placement = "H")
```

```{r FigureS3, fig.align='center', fig.height=8, fig.width=8, out.width='50%', fig.cap="Proportion of accuracy by condition and global language exposure in the test blocks. Individual dots plot the data from each individual participant.", warning=FALSE, cache=TRUE}
test_acc_exposure_plot <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  mutate(condition = recode(condition,
                            immediate_translation = "Immediate-translation",
                            one_language_at_a_time = "One-language-at-a-time")) %>%
  ggplot(aes(y = prop_accuracy, x = exposure, fill = lang_comm, color = lang_comm)) +
  geom_smooth(method="glm", se = F, size = 2) + 
  geom_point(alpha = 0.5, size = 3, position = position_jitter(w = 0.1, h = 0.1)) +
  #facet_grid(. ~ language) +
  ...
  theme_minimal() +
  scale_fill_manual(name = "Language community", values=c("#525252", "#bdbdbd", "#525252", "#bdbdbd")) +
  scale_color_manual(name = "Language community", values=c("#525252", "#bdbdbd", "#525252", "#bdbdbd")) +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, by = 0.1)) +
  theme(panel.spacing.x = unit(2.5, "lines"),
        text = element_text(size=20),
        axis.text = element_text(size = 20, color = "black"),
  ...
  labs(x = "\n Global language exposure",
       y = "Proportion of Accuracy",
       fill = "Language community",
       color = "Language community") +
  guides(fill=guide_legend(nrow=2,byrow=TRUE))

#ggsave(here("analysis/plot_test_acc_with_exposure.png"), test_acc_exposure_plot, 
#       width = 8, height = 8)

test_acc_exposure_plot

```


### Caregivers’ self-reported code-switching rating
Finally, we also explored the effect of caregivers’ code-switching practices on bilingual children’s learning of the novel cross-language words. Since our experiment only tested between-sentence switches, this analysis also focused on caregivers’ self-reported between-sentence code-switching practices. We added a variable of caregivers’ between-sentence code-switching rating to the logistic mixed-effects model used in the main accuracy analysis. Data from `r mean_exposure$n[mean_codeswitch$lang_comm=="French-English"]` French–English and `r mean_exposure$n[mean_codeswitch$lang_comm=="Spanish-English"]` Spanish–English children remained in the analysis (i.e., after excluding one French–English and three Spanish–English children participants who were missing their language exposure information). The final model specification after pruning random slope for condition to achieve model convergence was:

accuracy ~ condition * lang_community * codeswitch_rating + (1|participant) + (1|item)

```{r include=FALSE, cache=TRUE}
### glmer model
test_acc_model_with_codeswitch <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1+ condition|subject_id) + (1|stimulus), family = binomial, data = .)
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id) + (1|stimulus), family = binomial, data = .)
  glmer(accuracy ~ condition * lang_comm * codeswitch_between_sentence + (1|subject_id) + (1|stimulus), family = binomial, data = .,
        contrasts = list(condition = contr.sum(2)/-2,
                         lang_comm = contr.sum(2)/-2))


test_acc_model_with_codeswitch2 <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id) + (1|stimulus), family = binomial, data = .)
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id), family = binomial, data = .)
  glmer(accuracy ~ condition * lang_comm + (1|subject_id) + (1|stimulus), family = binomial, data = .,
        contrasts = list(condition = contr.sum(2)/-2))

anova(test_acc_model_with_codeswitch, test_acc_model_with_codeswitch2)

broom.mixed::tidy(test_acc_model_with_codeswitch) %>%
  mutate_if(is.numeric, round, digits = 3) 
...
```{r results = "asis", cache = TRUE, warning=FALSE, message=FALSE}
### Table S7
test_acc_model_with_codeswitch_coefs <- summary(test_acc_model_with_codeswitch)$coef %>%
  as.data.frame %>%
  mutate_at(c("Estimate","Std. Error", "z value", "Pr(>|z|)"), 
            function (x) signif(x, digits = 3)) %>% 
  rename(SE = `Std. Error`, 
...
rownames(test_acc_model_with_codeswitch_coefs) <- c("Intercept", "condition", "lang_community" ,"codeswitch_rating", 
                                                         "condition * lang_community", "condition * codeswitch_rating", 
                                                         "lang_community * codeswitch_rating", "condition * lang_community * codeswitch_rating")

papaja::apa_table(test_acc_model_with_codeswitch_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S7. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test blocks with caregivers’ self-reported between-sentence code-switching ratings.",
                  landscape = FALSE,
                  placement = "H")
```

\noindent While model comparison between the model with code-switching rating and the one without indicated no significant improvement in model fit, $\chi^2$(`r as.data.frame(anova(test_acc_model_with_codeswitch, test_acc_model_with_codeswitch2))[2,7]`) = `r round(as.data.frame(anova(test_acc_model_with_codeswitch, test_acc_model_with_codeswitch2))[2,6], 2)`, $p$ = `r round(as.data.frame(anova(test_acc_model_with_codeswitch, test_acc_model_with_codeswitch2))[2,8], 3)`, we listed the coefficient estimates from this model in Table S7 and visualized this model in Figure S4. Similar to the main analysis, no significant difference between conditions was found. However, there was a significant 3-way condition * language community * code-switching rating interaction. As can be seen in Figure S4, the two groups of bilinguals showed opposite patterns of performance when caregivers’ code-switching practice was taken into account. The French–English children showed greater accuracy under the one-language-at-a-time condition if their caregiver switched languages very frequently; whereas Spanish–English children were less accurate under the same condition. The reverse pattern was observed in the immediate-translation condition. The French–English children were relatively less accurate the more frequently their caregiver reported switched languages, whereas Spanish–English children were more accurate under the same condition. 

```{r FigureS4, fig.align='center', fig.height=8, fig.width=12, out.width='90%', fig.cap="Proportion of accuracy by condition and caregivers’ self-reported between-sentence code-switching rating in the test blocks. Individual dots plot the data from each participant.", warning=FALSE, cache=TRUE}
test_acc_codeswitch_plot <- data_clean %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  filter(missing_LEQ != 1) %>%
  # summarize
  group_by(subject_id, condition, lang_comm, codeswitch_between_sentence) %>%
  mutate(prop_accuracy = sum(accuracy, na.rm = T)/length(subject_id)) %>%
  distinct(subject_id, .keep_all = TRUE) %>%
  ungroup() %>%
  mutate(condition = recode(condition,
                            immediate_translation = "Immediate-translation",
                            one_language_at_a_time = "One-language-at-a-time")) %>%
  ggplot(aes(y = prop_accuracy, x = codeswitch_between_sentence, fill = condition, color = condition)) +
  geom_smooth(method="glm", se = F, size = 2) + 
  geom_point(alpha = 0.5, size = 3, position = position_jitter(w = 0.1, h = 0.1)) +
  facet_grid(. ~ lang_comm) +
  ...
  theme(panel.spacing.x = unit(2.5, "lines"),
        ...
        legend.position="bottom",
        plot.title = element_text(hjust = 0.5)) +
  labs(x = "\n Caregivers' between-sentence code-switching rating",
       y = "Proportion of Accuracy",
       fill = "Condition",
       color = "Condition") #+
  #guides(fill=guide_legend(nrow=2,byrow=TRUE))

#ggsave(here("analysis/plot_test_acc_with_codeswitch.png"), test_acc_codeswitch_plot, 
#       width = 12, height = 8)

test_acc_codeswitch_plot
...
TableS8 <- structure(
  list(
    " " = c("Overall", 
            ...
            " English", 
            " French/Spanish"),
    "N (%)" = c(paste0(mean_proficiency_prereg$n[mean_proficiency_prereg$lang_comm=="French-English"], 
                       " (", round(mean_proficiency_prereg$n[mean_proficiency_prereg$lang_comm=="French-English"]/22*100),"%)"), 
                " ", 
                " ",
                paste0(equal_proficiency_prereg$n[equal_proficiency_prereg$lang_comm=="French-English"], 
                       " (", round(equal_proficiency_prereg$n[equal_proficiency_prereg$lang_comm=="French-English"]/22*100), "%)"),
                paste0(dominant_eng_proficiency_prereg$n[dominant_eng_proficiency_prereg$lang_comm=="French-English"], 
                       " (", round(dominant_eng_proficiency_prereg$n[dominant_eng_proficiency_prereg$lang_comm=="French-English"]/22*100), "%)"), 
                " ", 
                " ",
                paste0(dominant_fr_proficiency_prereg$n, " (", round(dominant_fr_proficiency_prereg$n/22*100), "%)"), 
                " ", 
                " "),
    "Mean (SD)" = c(" ", 
                    paste0(mean_proficiency_prereg$mean_proficiency_eng[mean_proficiency_prereg$lang_comm=="French-English"], 
                           " (", mean_proficiency_prereg$sd_proficiency_eng[mean_proficiency_prereg$lang_comm=="French-English"],")"), 
                    paste0(mean_proficiency_prereg$mean_proficiency_fr[mean_proficiency_prereg$lang_comm=="French-English"], 
                           " (", mean_proficiency_prereg$sd_proficiency_fr[mean_proficiency_prereg$lang_comm=="French-English"],")"),
                    paste0(equal_proficiency_prereg$mean_proficiency_eng[equal_proficiency_prereg$lang_comm=="French-English"], 
                           " (", equal_proficiency_prereg$sd_proficiency_eng[equal_proficiency_prereg$lang_comm=="French-English"],")"),
                    " ", 
                    paste0(dominant_eng_proficiency_prereg$mean_proficiency_eng[dominant_eng_proficiency_prereg$lang_comm=="French-English"], 
                           " (", dominant_eng_proficiency_prereg$sd_proficiency_eng[dominant_eng_proficiency_prereg$lang_comm=="French-English"],")"), 
                    paste0(dominant_eng_proficiency_prereg$mean_proficiency_fr[dominant_eng_proficiency_prereg$lang_comm=="French-English"], 
                           " (", dominant_eng_proficiency_prereg$sd_proficiency_fr[dominant_eng_proficiency_prereg$lang_comm=="French-English"],")"),
                    " ", 
                    paste0(dominant_fr_proficiency_prereg$mean_proficiency_eng, " (", dominant_fr_proficiency_prereg$sd_proficiency_eng,")"), 
                    paste0(dominant_fr_proficiency_prereg$mean_proficiency_fr, " (", dominant_fr_proficiency_prereg$sd_proficiency_fr,")")),
    "Range" = c("",
                paste(mean_proficiency_prereg$min_proficiency_eng[mean_proficiency_prereg$lang_comm=="French-English"],
                      mean_proficiency_prereg$max_proficiency_eng[mean_proficiency_prereg$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                paste(mean_proficiency_prereg$min_proficiency_fr[mean_proficiency_prereg$lang_comm=="French-English"],
                      mean_proficiency_prereg$max_proficiency_fr[mean_proficiency_prereg$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                paste(equal_proficiency_prereg$min_proficiency_eng[equal_proficiency_prereg$lang_comm=="French-English"],
                      equal_proficiency_prereg$max_proficiency_eng[equal_proficiency_prereg$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_eng_proficiency_prereg$min_proficiency_eng[dominant_eng_proficiency_prereg$lang_comm=="French-English"]),
                paste(dominant_eng_proficiency_prereg$min_proficiency_fr[dominant_eng_proficiency_prereg$lang_comm=="French-English"],
                      dominant_eng_proficiency_prereg$max_proficiency_fr[dominant_eng_proficiency_prereg$lang_comm=="French-English"], 
                      sep=" \u2013 "),
                " ",
                paste(dominant_fr_proficiency_prereg$min_proficiency_eng,
                      dominant_fr_proficiency_prereg$max_proficiency_eng, 
                      sep=" \u2013 "),
                paste(dominant_fr_proficiency_prereg$min_proficiency_fr,
                      dominant_fr_proficiency_prereg$max_proficiency_fr, 
                      sep=" \u2013 ")),
    "N (%)" = c(paste0(mean_proficiency_prereg$n[mean_proficiency_prereg$lang_comm=="Spanish-English"], 
                       " (", round(mean_proficiency_prereg$n[mean_proficiency_prereg$lang_comm=="Spanish-English"]/14*100),"%)"), 
                " ", 
                " ",
                paste0(equal_proficiency_prereg$n[equal_proficiency_prereg$lang_comm=="Spanish-English"], 
                       " (", round(equal_proficiency_prereg$n[equal_proficiency_prereg$lang_comm=="Spanish-English"]/14*100), "%)"),
                paste0(0, " (", 0, "%)"), 
                " ", 
                " ",
                paste0(dominant_sp_proficiency_prereg$n, " (", round(dominant_sp_proficiency_prereg$n/14*100), "%)"), 
                " ", 
                " "),
    "Mean (SD)" = c(" ", 
                    paste0(mean_proficiency_prereg$mean_proficiency_eng[mean_proficiency_prereg$lang_comm=="Spanish-English"], 
                           " (", mean_proficiency_prereg$sd_proficiency_eng[mean_proficiency_prereg$lang_comm=="Spanish-English"],")"), 
                    paste0(mean_proficiency_prereg$mean_proficiency_sp[mean_proficiency_prereg$lang_comm=="Spanish-English"], 
                           " (", mean_proficiency_prereg$sd_proficiency_sp[mean_proficiency_prereg$lang_comm=="Spanish-English"],")"),
                    paste0(equal_proficiency_prereg$mean_proficiency_eng[equal_proficiency_prereg$lang_comm=="Spanish-English"], 
                           " (", equal_proficiency_prereg$sd_proficiency_eng[equal_proficiency_prereg$lang_comm=="Spanish-English"],")"),
                    " ", 
                    "—",
                    "—",
                    " ", 
                    paste0(dominant_sp_proficiency_prereg$mean_proficiency_eng, " (", dominant_sp_proficiency_prereg$sd_proficiency_eng,")"), 
                    paste0(dominant_sp_proficiency_prereg$mean_proficiency_sp, " (", dominant_sp_proficiency_prereg$sd_proficiency_sp,")")),
    "Range" = c("",
                paste(mean_proficiency_prereg$min_proficiency_eng[mean_proficiency_prereg$lang_comm=="Spanish-English"],
                      mean_proficiency_prereg$max_proficiency_eng[mean_proficiency_prereg$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                paste(mean_proficiency_prereg$min_proficiency_sp[mean_proficiency_prereg$lang_comm=="Spanish-English"],
                      mean_proficiency_prereg$max_proficiency_sp[mean_proficiency_prereg$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                paste(equal_proficiency_prereg$min_proficiency_eng[equal_proficiency_prereg$lang_comm=="Spanish-English"],
                      equal_proficiency_prereg$max_proficiency_eng[equal_proficiency_prereg$lang_comm=="Spanish-English"], 
                      sep=" \u2013 "),
                " ",
                "—",
                "—",
                " ",
                paste(dominant_sp_proficiency_prereg$min_proficiency_eng,
                      dominant_sp_proficiency_prereg$max_proficiency_eng, 
                      sep=" \u2013 "),
                paste(dominant_sp_proficiency_prereg$min_proficiency_sp,
                      dominant_sp_proficiency_prereg$max_proficiency_sp, 
                      sep=" \u2013 "))
...
TableS8_indent <- list(c(2,3,6,7,9,10))

papaja::apa_table(TableS8,
                  caption = "Table S8. Language proficiency scores across the two groups of bilingual children whose proficiency scores were available. ",
                  align = c("l", rep("c", 6)),
                  stub_indents = TableS1_indent,
                  col_spanners = list("French\u2013English" = 2:4, "Spanish\u2013English" = 5:7),
                  landscape = FALSE,
...
papaja::apa_table(prereg_test_acc_model_coefs, 
                  ...
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S9. Coefficient estimates from the logistic mixed-effects models predicting accuracy in the test phase.",
                  landscape = FALSE,
                  placement = "H")
```


```{r FigureS5, fig.align='center', fig.height=6, fig.width=6, out.width='60%', fig.cap="Average proportion of accuracy by condition and language community in the test blocks. Dots plot the data from each individual participant. Error bars indicate 95\\% confidence intervals, and the black dashed line represents the at-chance accuracy level of 0.50.", warning=FALSE, cache=TRUE}
...
papaja::apa_table(prereg_test_acc_model_age_coefs, 
                  ...
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S10. Coefficient estimates from the logistic mixed-effects models predicting accuracy in the the test phase with age_in_months as an additional fixed effect.",
                  landscape = FALSE,
                  placement = "H")
```

```{r FigureS6, fig.align='center', fig.height=8, fig.width=12, out.width='90%', fig.cap="Proportion of accuracy by condition, language community, and age in the test phase. Individual dots plot the data from each individual participant.", warning=FALSE, cache=TRUE}
## ggplot with age
...
papaja::apa_table(prereg_test_rt_model_with_age_coefs, 
                  ...
                  col.names =c("","Estimate", "$SE$","$t$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S11. Coefficient estimates from the linear mixed-effects model predicting log-transformed response time in the test phase.",
                  landscape = FALSE,
                  placement = "H")
```

```{r FigureS7, fig.align='center', fig.height=8, fig.width=12, out.width='90%', fig.cap="Response time by condition, language community, and age in the test phase. Individual dots plot the data from each individual participant.", warning=FALSE, cache=TRUE}
...
papaja::apa_table(all_test_acc_model_with_proficiency_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("m{8cm}","c","c","c","c"),
                  caption="Table S12. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test phase with proficiency scores among all the children.",
                  landscape = FALSE,
                  placement = "H")
```

```{r FigureS8, fig.align='center', fig.height=8, fig.width=8, out.width='50%', fig.cap="Proportion of accuracy of all children by condition and proficiency in the test blocks. Individual dots plots the data from each individual participant.", warning=FALSE, cache=TRUE}
...
#### Global language exposure in all participants
```{r include=FALSE, cache=TRUE}
# ---------- exposure ----------
## overall mean
mean_exposure_all <- data_clean_all %>%
  distinct(subject_id, .keep_all = T) %>%
  select(subject_id, lang_comm, matches("global_")) %>%
  group_by(lang_comm) %>%
  dplyr::summarize(n = length(subject_id),
...
round(mean_exposure_all$max_exposure_fr[mean_exposure_all$lang_comm=="French-English"])
```

Similar to the proficiency analysis, we also included data from all children in this analysis. Among this group of `r data_clean_all %>% filter(lang_comm == "French-English") %>% distinct(subject_id) %>% nrow()` French–English children and `r data_clean_all %>% filter(lang_comm == "Spanish-English") %>% distinct(subject_id) %>% nrow()` Spanish–English children, the French–English children had a mean global exposure of `r round(mean_exposure_all$mean_exposure_eng[mean_exposure_all$lang_comm=="French-English"])`% to English ($SD$ = `r round(mean_exposure_all$sd_exposure_eng[mean_exposure_all$lang_comm=="French-English"], 2)`, range = `r round(mean_exposure_all$min_exposure_eng[mean_exposure_all$lang_comm=="French-English"])` – `r round(mean_exposure_all$max_exposure_eng[mean_exposure_all$lang_comm=="French-English"])`) and `r round(mean_exposure_all$mean_exposure_fr[mean_exposure_all$lang_comm=="French-English"])`% to French ($SD$ = `r round(mean_exposure_all$sd_exposure_fr[mean_exposure_all$lang_comm=="French-English"], 2)`, range = `r round(mean_exposure_all$min_exposure_fr[mean_exposure_all$lang_comm=="French-English"])` – `r round(mean_exposure_all$max_exposure_fr[mean_exposure_all$lang_comm=="French-English"])`), and the Spanish–English children had a mean global exposure of `r round(mean_exposure_all$mean_exposure_eng[mean_exposure_all$lang_comm=="Spanish-English"])`% to English ($SD$ = `r round(mean_exposure_all$sd_exposure_eng[mean_exposure_all$lang_comm=="Spanish-English"], 2)`, range = `r round(mean_exposure_all$min_exposure_eng[mean_exposure_all$lang_comm=="Spanish-English"])` – `r round(mean_exposure_all$max_exposure_eng[mean_exposure_all$lang_comm=="Spanish-English"])`) and `r round(mean_exposure_all$mean_exposure_sp[mean_exposure_all$lang_comm=="Spanish-English"])`% to Spanish ($SD$ = `r round(mean_exposure_all$sd_exposure_sp[mean_exposure_all$lang_comm=="Spanish-English"], 2)`, range = `r round(mean_exposure_all$min_exposure_sp[mean_exposure_all$lang_comm=="Spanish-English"])` – `r round(mean_exposure_all$max_exposure_sp[mean_exposure_all$lang_comm=="Spanish-English"])`). To explore the effect of global language exposure, a variable of global language exposure was added to the logistic mixed-effects model. The final model specification after removing the random slope for condition to achieve model convergence was:

accuracy ~ condition * lang_community * exposure + (1|participant) + (1|item)

```{r include=FALSE, cache=TRUE}
### glmer model
all_test_acc_model_with_exposure_withlangcomm <- data_clean_all %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
  ...
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1+ condition|subject_id) + (1|stimulus), family = binomial, data = .)
  #glmer(accuracy ~ condition * lang_comm * language_proficiency + (1|subject_id) + (1|stimulus), family = binomial, data = .)
  glmer(accuracy ~ condition * lang_comm * exposure + (1|subject_id) + (1|stimulus), family = binomial, data = .,
        contrasts = list(condition = contr.sum(2)/-2,
                         lang_comm = contr.sum(2)/-2))

broom.mixed::tidy(all_test_acc_model_with_exposure_withlangcomm) %>%
  mutate_if(is.numeric, round, digits = 3) 
```
...
```{r results = "asis", cache = TRUE, warning=FALSE, message=FALSE}
### Table S13
all_test_acc_model_with_exposure_withlangcomm_coefs <- summary(all_test_acc_model_with_exposure_withlangcomm)$coef %>%
  as.data.frame %>%
  mutate_at(c("Estimate","Std. Error", "z value", "Pr(>|z|)"), 
            function (x) signif(x, digits = 3)) %>% 
  rename(SE = `Std. Error`, 
...
rownames(all_test_acc_model_with_exposure_withlangcomm_coefs) <- c("Intercept", "condition", "lang_community" ,"exposure", 
                                                         "condition * lang_community", "condition * exposure", 
                                                         "lang_community * exposure", "condition * lang_community * exposure")

papaja::apa_table(all_test_acc_model_with_exposure_withlangcomm_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S13. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test phase with global language exposure among all the children.",
                  landscape = FALSE,
                  placement = "H")
```

```{r FigureS9, fig.align='center', fig.height=8, fig.width=8, out.width='50%', fig.cap="Proportion of accuracy by condition and global language exposure in the test blocks. Individual dots plot the data from each individual participant.", warning=FALSE, cache=TRUE}
all_test_acc_exposure_plot <- data_clean_all %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
...
#ggsave(here("analysis/plot_test_acc_with_exposure_all.png"), all_test_acc_exposure_plot, 
#       width = 8, height = 8)

all_test_acc_exposure_plot

```

#### Caregivers’ self-reported code-switching rating in all participants
```{r include=FALSE, cache=TRUE}
# ---------- exposure ----------
## overall mean
mean_codeswitch_all <- data_clean_all %>%
  distinct(subject_id, .keep_all = T) %>%
  select(subject_id, lang_comm, matches("codeswitch_"), -codeswitch_average) %>%
  group_by(lang_comm) %>%
  dplyr::summarize(n = length(subject_id),
...
Finally, we also explored the effect of caregivers’ self-reported code-switching practices on all children’s novel word learning. Among this group of `r data_clean_all %>% filter(lang_comm == "French-English") %>% distinct(subject_id) %>% nrow()` French–English children and `r data_clean_all %>% filter(lang_comm == "Spanish-English") %>% distinct(subject_id) %>% nrow()` Spanish–English children, caregivers of the French–English children reported a rating of `r round(mean_codeswitch_all$mean_codeswitch_within[mean_codeswitch_all$lang_comm=="French-English"], 2)` for within-sentences code-switch ($SD$ = `r round(mean_codeswitch_all$sd_codeswitch_within[mean_codeswitch_all$lang_comm=="French-English"], 2)`, range = `r round(mean_codeswitch_all$min_codeswitch_within[mean_codeswitch_all$lang_comm=="French-English"])` – `r round(mean_codeswitch_all$max_codeswitch_within[mean_codeswitch_all$lang_comm=="French-English"])`) and `r round(mean_codeswitch_all$mean_codeswitch_between[mean_codeswitch_all$lang_comm=="French-English"], 2)` for between-sentence code-switch ($SD$ = `r round(mean_codeswitch_all$sd_codeswitch_between[mean_codeswitch_all$lang_comm=="French-English"], 2)`, range = `r round(mean_codeswitch_all$min_codeswitch_between[mean_codeswitch_all$lang_comm=="French-English"])` – `r round(mean_codeswitch_all$max_codeswitch_between[mean_codeswitch_all$lang_comm=="French-English"])`), and caregivers of the Spanish–English children reported a rating of `r round(mean_codeswitch_all$mean_codeswitch_within[mean_codeswitch_all$lang_comm=="Spanish-English"], 2)` for within-sentences code-switch ($SD$ = `r round(mean_codeswitch_all$sd_codeswitch_within[mean_codeswitch_all$lang_comm=="Spanish-English"], 2)`, range = `r round(mean_codeswitch_all$min_codeswitch_within[mean_codeswitch_all$lang_comm=="Spanish-English"])` – `r round(mean_codeswitch_all$max_codeswitch_within[mean_codeswitch_all$lang_comm=="Spanish-English"])`) and `r round(mean_codeswitch_all$mean_codeswitch_between[mean_codeswitch_all$lang_comm=="Spanish-English"], 2)` for between-sentence code-switch ($SD$ = `r round(mean_codeswitch_all$sd_codeswitch_between[mean_codeswitch_all$lang_comm=="Spanish-English"], 2)`, range = `r round(mean_codeswitch_all$min_codeswitch_between[mean_codeswitch_all$lang_comm=="Spanish-English"])` – `r round(mean_codeswitch_all$max_codeswitch_between[mean_codeswitch_all$lang_comm=="Spanish-English"])`). To explore the effect of caregivers’ code-switching practice, we focused only on their between-sentence code-switching rating since our study only tested between-sentence language switches. Following the model used in the main analysis, we added a variable of caregivers’ between-sentence code-switching rating to the logistic mixed-effects model. The final model specification was:

accuracy ~ condition * lang_community * codeswitch_rating + (1|participant) + (1|item)

```{r include=FALSE, cache=TRUE}
### glmer model
all_test_acc_model_with_codeswitch <- data_clean_all %>%
  # filter trials without any response 
  filter(rt < 10000 | !is.na(rt)) %>%
  # keep only familiar test and novel test
  filter(test_part == "nov_test") %>%
...
broom.mixed::tidy(all_test_acc_model_with_codeswitch) %>%
  mutate_if(is.numeric, round, digits = 3) 
```
...
```{r results = "asis", cache = TRUE, warning=FALSE, message=FALSE}
### Table S14
all_test_acc_model_with_codeswitch_coefs <- summary(all_test_acc_model_with_codeswitch)$coef %>%
  as.data.frame %>%
  mutate_at(c("Estimate","Std. Error", "z value", "Pr(>|z|)"), 
            function (x) signif(x, digits = 3)) %>% 
  rename(SE = `Std. Error`, 
...
rownames(all_test_acc_model_with_codeswitch_coefs) <- c("Intercept", "condition", "lang_community" ,"codeswitch_rating", 
                                                         "condition * lang_community", "condition * codeswitch_rating", 
                                                         "lang_community * codeswitch_rating", "condition * lang_community * codeswitch_rating")

papaja::apa_table(all_test_acc_model_with_codeswitch_coefs, 
                  format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c"),
                  caption="Table S14. Coefficient estimates from the logistic mixed-effects model predicting accuracy in the test blocks with caregivers’ self-reported between-sentence code-switching ratings.",
                  landscape = FALSE)
```
